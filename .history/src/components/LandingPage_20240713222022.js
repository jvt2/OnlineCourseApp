  ...
  return (
    <div className="sign-in-container">
      <div className="sign-in-form">
        <img src={`${process.env.PUBLIC_URL}/assets/new_logo.png`} alt="Logo" className="logo" />
        <h1>Sign in</h1>
        <p className="subtitle">Level Up Your Career: Skills Analysis & Targeted Course Recommendations</p>
