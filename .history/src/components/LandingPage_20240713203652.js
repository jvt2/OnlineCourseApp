  ...
  return (
    <div className="sign-in-container">
      <div className="sign-in-form">
        <img src={`${process.env.PUBLIC_URL}/assets/favicon.ico`} alt="Logo" className="logo" />
        <h1>Sign in</h1>
        <p className="subtitle">to continue to Galileo AI</p>
        <button className="google-sign-in">
          <img src={`${process.env.PUBLIC_URL}/public/google-logo.png`} alt="Google" className="google-logo" />
